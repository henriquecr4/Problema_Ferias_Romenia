...
def Cria_Mapa_Romenia():
    ...
    Estados = [Arad, Bucharest, Craiova, Drobreta, Eforie, Fagaras, Giurgiu, Hirsova, Iasi, Lugoj, Mehadia, Neamt, Oradea, Pitesti, Rimnicu_Vilcea, Sibiu, Timisoara, Urzineci, Vaslui, Zerind]
